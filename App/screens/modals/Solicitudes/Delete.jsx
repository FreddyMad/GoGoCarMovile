...
const DeleteSolicitud = ({ modalOpen, onClose }) => {
	...
	return (
		<Modal isOpen={modalOpen} onClose={onClose}
			title='¿Estás seguro de cancelar tu solicitud?' headerIcon="file" iconColor={colors.rojo} iconBackground={colors.rojoFondo}>
			{{
				...
				return (
					<>
						<Text style={{color: 'gray', fontWeight: 'bold', fontSize: 17, marginBottom: 3}}>
                            Podrás seguir solicitando viajes
                        </Text>
					</>
				)
			}}
