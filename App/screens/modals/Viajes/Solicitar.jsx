...
const SolicitarViaje = ({ modalOpen, onClose }) => {
	...
	return (
		<Modal isOpen={modalOpen} onClose={onClose}
			title='¿Estás seguro de solicitar este viaje?' headerIcon="road">
			{{
	...
	return (
		...
		>
			{({ errors, values, handleChange }) => {
				return (
					<>
						<Text style={{color: 'red', fontWeight: 'bold', fontSize: 17, marginBottom: 3}}>
                            Recuerda postularte sólo a viajes necesarios
                        </Text>
					</>
				)
			}}
