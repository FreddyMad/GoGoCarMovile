...
const DeleteViaje = ({ modalOpen, onClose }) => {
	...
	return (
		<Modal isOpen={modalOpen} onClose={onClose}
			title='¿Estás seguro de eliminar este viaje?' headerIcon="road" iconColor={colors.rojo} iconBackground={colors.rojoFondo}>
			{{
				...
				return (
					<>
						<Text style={{color: 'gray', fontWeight: 'bold', fontSize: 17, marginBottom: 3}}>
                            Todos los datos relacionados con el viaje serán eliminados permanentemente.
                        </Text>
					</>
				)
			}}
